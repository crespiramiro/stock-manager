...
export default function Slidebar (){
    ...
    return (
        <section className={`flex flex-col gap-y-12 h-dvh ${isOpen ? 'w-1/2 md:w-[30%] ' : 'w-3/12 md:w-2/12 '} text-center bg-black text-[#f5f5f5] px-4 md:px-12 py-8 transition-all duration-300`}>
